...
class App(tk.Frame):
    def __init__(self, master):
        ...
        self.label = tk.Label(frame1, text="Set value for magnetic flux")
        self.label.pack(side=LEFT, padx=5, pady=5)
        self.entry = tk.Entry(frame1,text="50", width=5, bg="white")
        self.entry.insert(0,"0")
        self.entry.pack(side=LEFT)
        self.labelunit = tk.Label(frame1, text="G")
        ...
        frame3.pack(fill=X)
        self.label1 = tk.Label(frame3, text="Save calibration, use \"open\" / \"load\" / \"short\"")
        self.label1.pack(side=LEFT, padx=5)
        self.entry1 = tk.Entry(frame3, width = 6)
