...
stepsize=100
steps=4095/stepsize
values=np.arange(0,4100,stepsize)
values=np.append(values,4095)
nvals=10000
mean=np.arange(steps+1, dtype=float)#42
...
np.savetxt('/home/at/suscept/magnari/Mælingar/output.dat', dataout, header='#coil source value, mean of analog output, standard deviation of the output', fmt=('%5.f', '%3.3f', '%4.4f'))
...
plt.show()
np.savetxt('/home/at/suscept/magnari/Mælingar/calib_results.dat', parameters, header='#Slope and intercept')
